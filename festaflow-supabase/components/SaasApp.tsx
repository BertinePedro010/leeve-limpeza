...
type RecurringSchedule = { id: string; frequency: "weekly" | "monthly"; interval: number; dayOfWeek?: number | null; daysOfWeek?: number[] | null; dayOfMonth?: number | null; startDate: string; endDate?: string | null; active: boolean; price: string | number };
